...
namespace WebAppTp2.Controllers
{
    public class MarquesController : Controller
    {
        ...
        public MarquesController(VoitureDbEntities context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Marques != null ? 
                          ...
                          Problem("Entity set 'VoitureDbEntities.Marques'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VoitureDbEntities.Marques'  is null.");
            }
            var marque = await _context.Marques.FindAsync(id);
            if (marque != null)
            {
